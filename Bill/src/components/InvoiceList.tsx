  ...
  return (
    <div className="flex-1 bg-[#F8FAFC] pb-24 lg:pb-8">
      ...
      <header className="sticky top-0 bg-white border-b border-slate-100 px-4 py-4 md:px-8 z-10 flex items-center justify-between gap-4">
        <div>
          <h1 className="font-sans font-bold text-xl md:text-2xl text-slate-800">{t.invoices}</h1>
          <p className="text-xs text-slate-400 mt-0.5">
            {profile.language === 'id' 
              ? `Total ${invoices.length} tagihan tercatat` 
              : `Total ${invoices.length} recorded invoices`
            }
          </p>
        </div>
        ...
        <button
          ...
          className="py-2.5 px-4 bg-[#2563EB] hover:bg-blue-700 transition-all text-white font-sans font-semibold rounded-xl flex items-center gap-2 text-sm shadow-md shadow-blue-100 cursor-pointer"
        >
          <Plus size={16} />
