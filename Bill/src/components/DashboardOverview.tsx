    ...
    <div className="flex-1 min-w-0 bg-[#F8FAFC] pb-24 lg:pb-8">
      ...
      <header className="sticky top-0 bg-white border-b border-slate-100 px-4 py-4 md:px-8 z-10 flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          {/* Quick Invoice for Mobile Header */}
          <button 
            onClick={onQuickInvoice}
            className="lg:hidden flex items-center gap-1.5 px-3 py-1.5 bg-[#2563EB] hover:bg-blue-600 text-white rounded-xl text-xs font-semibold cursor-pointer shadow-md shadow-blue-100"
          >
            {t.quickInvoice}
          </button>
          ...
          <div className="hidden md:flex items-center gap-2 bg-slate-50 px-3 py-1.5 rounded-full border border-slate-100">
            ...
            <span className="text-xs font-medium text-slate-500">{t.realTimeFilter}</span>
          </div>
          ...
          {/* Notifications Icon */}
          <button className="p-2 hover:bg-slate-50 rounded-xl border border-slate-100 text-slate-600 relative">
            <Bell size={18} />
